...
- 请先快速浏览一遍，若觉得过于麻烦可赞助30元获取远程安装服务（安装不成功不收钱）
- 远程安装服务自带1辆部分隐藏车自选与白表&特殊表的奖励
- 不推荐自行安装，因为很多步骤虽然尽力表达出来了，但大部分人都没办法理解是什么意思
...
{% include callout.html text="<b>注意！</b><br>推荐使用Bandzip进行解压<br>其他解压软件可能导致游戏本体无法正常运行" color="red" %}
...
{% include callout.html text="<b>警告！</b><br>若最后修复C++过程中遇到无法安装问题，请继续即可<br>一般并不影响游戏运行" color="red" %}
